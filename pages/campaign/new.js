...
import { getETHPrice, getETHPriceInRupee } from "../../lib/getETHPrice";
    ...
    <div>
      ...
      <main>
        <Stack spacing={8} mx={"auto"} maxW={"2xl"} py={12} px={6}>
          <Text fontSize={"lg"} color={"#9c3353"}>
            <ArrowBackIcon mr={2} />
            <NextLink href="/"> Back to Home</NextLink>
          </Text>
          <Stack>
            <Heading fontSize={"4xl"}>Start a new Campaign 📢</Heading>
          </Stack>
          <Box
            rounded={"lg"}
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <Stack spacing={4}>
                <FormControl id="minimumContribution">
                  ...
                  {minContriInUSD ? (
                    <FormHelperText>
                      ~ &#8377; {getETHPriceInRupee(ETHPrice, minContriInUSD)}
                    </FormHelperText>
                  ) : null}
                </FormControl>
                ...
                <FormControl id="target">
                  ...
                  {targetInUSD ? (
                    <FormHelperText>
                      ~ &#8377; {getETHPriceInRupee(ETHPrice, targetInUSD)}
                    </FormHelperText>
                  ) : null}
                </FormControl>
