...
export default function CampaignSingle({
  ...
  const y=web3.utils.fromWei(target, "ether");
            ...
            <Stack  spacing={{ base: 4 }}>
                  ...
                  <StatNumber>
                    ...
                    >
                      ...
                      <Text
                        ...
                        color={useColorModeValue("gray.500", "gray.200")}
                      >
                        (&#8377; {getWEIPriceInRupee(ETHPrice, balance)})
                      </Text>
                    </Box>

                    <Text fontSize={"md"} fontWeight="normal">
                      target of {web3.utils.fromWei(target, "ether")} ETH (&#8377;
                      {getWEIPriceInRupee(ETHPrice, target)})
                    </Text>
                    {/* <Progress
                      colorScheme="pink"
                      size="sm"
              ...
              >
                <Heading
                  ...
                  color={useColorModeValue("#9C3353", "#af5b75")}
                >
                  Contribute Now!
                </Heading>
                ...
                <Box mt={10}>
                  <form onSubmit={handleSubmit(onSubmit)}>
                    <FormControl id="value">
                      ...
                      {amountInUSD ? (
                        <FormHelperText>
                          ~ &#8377; {getETHPriceInRupee(ETHPrice, amountInUSD)}
                        </FormHelperText>
                      ) : null}
                    </FormControl>
                    ...
                    <Stack spacing={10}>
                      {wallet.status === "connected" ? (
                        <Button
                          ...
                          mt={4}
                          w={"full"}
                          bgGradient="linear-gradient(90deg, rgba(78,25,41,1) 13%, rgba(156,51,83,1) 100%, rgba(205,153,169,1) 100%)"
                          color={"white"}
                          _hover={{
                            bgGradient: "linear-gradient(90deg, rgba(78,25,41,1) 0%, rgba(156,51,83,1) 11%, rgba(205,153,169,1) 100%)",
                            boxShadow: "xl",
                          }}
