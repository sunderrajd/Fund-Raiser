...
import { getETHPrice, getWEIPriceInRupee } from "../lib/getETHPrice";
import {
  Heading,
  useBreakpointValue,
  useColorModeValue,
  ...
  return (
    <div>
      ...
      <Heading
          ...
          <Heading size='md' > Bringing Trust and Transparency to  Crowdfunding <br/> through Blockchain{" "} </Heading>
        
      </Box>
      </Center>
      <Box margin='auto'><Image   src="/images/image.png" alt='banner' /></Box>
        ...
        <Container py={{ base: "4", md: "12" }} maxW={"7xl"}>
          <HStack spacing={2}>
            ...
            <Heading as="h2" size="lg" color="#9c3353">
              Open Campaigns
            </Heading>
          </HStack>
